...
public class MasterDetail {
     ...
     * @param name
     */
    public MasterDetail(String name) {
        super();
        this.name = name;
    }
    ...
    public MasterDetail withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public MasterDetail withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MasterDetail) == false) {
            return false;
        }
        MasterDetail rhs = ((MasterDetail) other);
